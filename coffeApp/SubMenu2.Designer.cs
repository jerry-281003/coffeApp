namespace coffeApp
{
	partial class SubMenu2
	{
		...
		private void InitializeComponent()
		{
			...
			Menubutton.Location = new Point(-17, -3);
			...
			// groupBox1
			// 
			groupBox1.Controls.Add(TotalBill);
			...
			groupBox1.Size = new Size(1158, 621);
			...
			TotalBill.Location = new Point(1000, 70);
			TotalBill.Name = "TotalBill";
			TotalBill.Size = new Size(22, 25);
			TotalBill.TabIndex = 39;
			TotalBill.Text = "0";
			// 
			// Total
			// 
			Total.AutoSize = true;
			Total.Location = new Point(982, 70);
			Total.Name = "Total";
			...
			label1.Location = new Point(907, 70);
			label1.Name = "label1";
			...
			// btnOrder
			// 
			btnOrder.Location = new Point(977, 121);
